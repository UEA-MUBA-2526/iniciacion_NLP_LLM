...
Cabe mencionar que dada las caracterisitcas de mi equipo MAC ventura, se trabajo especialmente para configurar un entorno 

Se recomienda usar Python 3.12+ para este curso. Puedes gestionar las dependencias usando **pip** (con `requirements.txt`)
